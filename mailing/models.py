...
class MailingLog(models.Model):
    ...
    # mailing_log_email = models.ForeignKey(Client, on_delete=models.CASCADE, verbose_name='email', **NULLABLE)
...
class MailingSetting(models.Model):
    ...
    # mailing_set_date = models.DateField(verbose_name='дата рассылки', **NULLABLE)
